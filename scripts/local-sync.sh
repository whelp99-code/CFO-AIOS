...
MAC_DEFAULT="/Users/jmpark/Playground/CFO-AI"
...
if is_cloud_vm; then
  ...
  echo "   mkdir -p /Users/jmpark/Playground"
  echo "   git clone https://github.com/whelp99-code/CFO-AIOS.git /Users/jmpark/Playground/CFO-AI"
  echo "   cd /Users/jmpark/Playground/CFO-AI && ./scripts/local-sync.sh"
  echo ""
  sync_repo "$REPO_ROOT"
  exit 0
fi
...
echo "  mkdir -p /Users/jmpark/Playground"
echo "  git clone https://github.com/whelp99-code/CFO-AIOS.git /Users/jmpark/Playground/CFO-AI"
echo "  cd /Users/jmpark/Playground/CFO-AI"
