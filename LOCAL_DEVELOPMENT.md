...
| 환경 | 경로 |
|------|------|
| Mac (기본) | `/Users/jmpark/Playground/CFO-AI` |
| GitHub | https://github.com/whelp99-code/CFO-AIOS |

## 최초 설정

```bash
mkdir -p /Users/jmpark/Playground
git clone https://github.com/whelp99-code/CFO-AIOS.git /Users/jmpark/Playground/CFO-AI
